 ...
 <?php
       ...
       ?>
        ...
        <div data-role="footer" data-id="toolbar" data-position="fixed">
            ...
            <a href="crear_proyecto.php" data-role="button" data-icon="plus">Crear nueva meta</a>
            <a href="modificar_proyecto.php" data-role="button" data-icon="arrow-u">Modifica tu meta</a>
            <a href="http://www.facebook.com/dialog/apprequests?app_id=435104126547108&message=Ahorra%20un%203,5%%20para%20tus%20sue%C3%B1os%20con%20tus%20amigos!&redirect_uri=http://admobile.es/finapps/" data-role="button" data-icon="arrow-u">Invita a tus amigos</a>
            <a href="micuentaController.php" data-role="button" data-icon="arrow-d">Cuentas asociadas</a>
                </div>
