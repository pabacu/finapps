...
<div id="metaListPage" data-role="page">
	...
	<div data-role="content">
         <ul id="metaList" data-role="listview" data-filter="true" data-split-icon="gear">
         <?php
 ...
 if(isset($_GET['id_name']))
 {
	...
	$conexion = mysql_connect ("mysql5-7.start", "admobilefb", "finapps4")
      ...
      $instruccion = "select * from metas where id_user=".$_GET['id_name'];
       ...
       ?>
        ...
        <div data-role="footer" data-id="toolbar" data-position="fixed">	
                        <div data-role="navbar">
                                <ul>
                                        <li>
                                                <a href="crear_proyecto.php" data-icon="star" data-transition="fade">
                                                Crear nuevo proyecto</a>
                                        </li>	
                                        <li><a class="ui-btn-active" href="#" data-icon="info" data-transition="fade">
                                                FAQ</a>
                                        </li>	
                                </ul>
                        </div>
